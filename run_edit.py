...
if __name__ == '__main__':
    ...
    if args.local or (args.internet and args.cluster_engine != 'lsf'):
        ...
        if args.log_file is not None:
            qsub_args += " --error {}".format(args.log_file)  
        ...
        if args.log_file is not None:
            qsub_args += " -o {out} -e {err}".format(out=args.log_file, err=args.err_file)
        # should be fine, added err=args.err_file
